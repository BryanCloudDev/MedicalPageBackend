...
export class AdministratorUserResponse {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'The date when the administrator record was deleted',
...
export class AdministratorResponse {
  ...
  @ApiProperty({
    description: 'The administrator data',
    type: AdministratorUserResponse
  })
  administrator: AdministratorUserResponse
}
